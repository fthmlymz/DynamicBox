...
using DynamicBox.Admin.ExceptionHandling;
using DynamicBox.Admin.Configuration;
using DynamicBox.Admin.Configuration.ApplicationParts;
...
using DynamicBox.Admin.Helpers.Localization;
using System.Linq;
...
namespace DynamicBox.Admin.Helpers
{
