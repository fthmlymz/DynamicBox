...
using SendGrid;
using DynamicBox.Shared.Configuration.Email;
using DynamicBox.Shared.Email;
using DynamicBox.STS.Identity.Configuration;
using DynamicBox.STS.Identity.Configuration.ApplicationParts;
using DynamicBox.STS.Identity.Configuration.Constants;
using DynamicBox.STS.Identity.Configuration.Interfaces;
using DynamicBox.STS.Identity.Helpers.Localization;
using System.Linq;
using IdentityServer4;
using Microsoft.AspNetCore.Authentication.AzureAD.UI;
using Microsoft.AspNetCore.Authentication.OAuth;
using Skoruba.IdentityServer4.Admin.EntityFramework.Interfaces;
//using DynamicBox.Admin.EntityFramework.MySql.Extensions;
//using DynamicBox.Admin.EntityFramework.PostgreSQL.Extensions;
using DynamicBox.Admin.EntityFramework.Shared.Configuration;
using DynamicBox.Admin.EntityFramework.SqlServer.Extensions;
using Skoruba.IdentityServer4.Admin.EntityFramework.Helpers;
using Microsoft.AspNetCore.DataProtection.EntityFrameworkCore;
using Microsoft.AspNetCore.Http;
using Microsoft.IdentityModel.Tokens;
using DynamicBox.Shared.Authentication;
using DynamicBox.Shared.Configuration.Identity;

namespace DynamicBox.STS.Identity.Helpers
{
