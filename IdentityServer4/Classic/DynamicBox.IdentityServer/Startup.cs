    ...
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            var builder = services.AddIdentityServer(options =>
            {
                ...
                .AddConfigurationStore(opts => //Config dosyasını db aktarmak icin(client, resource, scopes
                {
                ...
                .AddOperationalStore(opts => //Config dosyasını db aktarmak icin (refresh token, authorization code)
                {
                    opts.ConfigureDbContext = c => c.UseSqlServer(Configuration.GetConnectionString("IdentityServerDbConnection"), sqlOptions => sqlOptions.MigrationsAssembly(assemblyName));
                })
